      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 bg-slate-800 p-8 rounded-lg">
          <ContactForm showTitle={true} rows={6} />
           <div className="text-slate-300">
             ...
             <p className="mb-2">Test Data</p>
             <p className="mb-4">Test Data</p>
             
             <p className="mb-2"><strong className="text-white">Email:</strong> contact@test.com</p>
             <p className="mb-4"><strong className="text-white">Phone:</strong> test cell</p>
